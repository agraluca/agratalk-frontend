    ...
    switch (action.type) {
      ...
      case "titleRules":
        if (!action.value.trim()) {
          ...
          draft.title.message = "Você deve preencher o titulo.";
        }
        return;
      case "bodyRules":
        if (!action.value.trim()) {
          draft.body.hasErrors = true;
          draft.body.message = "Você deve preencher o corpo do texto.";
        }
        return;
      case "notFound":
        draft.notFound = true;
